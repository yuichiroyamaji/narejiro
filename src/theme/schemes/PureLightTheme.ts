...
const colors = {
  ...
  alpha: {
    ...
    green: {
      5: alpha(themeColors.green, 0.02),
      10: alpha(themeColors.green, 0.1),
      30: alpha(themeColors.green, 0.3),
      50: alpha(themeColors.green, 0.5),
      70: alpha(themeColors.green, 0.7),
      100: themeColors.green
    }
  },
  secondary: {
